    ...
    hooks = [
        ...
        dict(type='WandbLoggerHook', interval=1000,
            init_kwargs= dict(
                ...
                name = 'swin_dyhead_baseline_lr_config_cosinerestart',
                config= {
...
log_config = dict(hooks = [
    ...
    dict(type='MMDetWandbHook',
        init_kwargs={
            'project': 'Object Detection',
            'entity' : 'boostcamp-cv-13',
            'name' : 'swin_dyhead_baseline_lr_config_cosinerestart_mmdetwandb_12-12_0.0001',
            'config' : {
                    'optimizer_type':optimizer['type'],
                    'optimizer_lr':optimizer['lr'],
                    'neck_type':neck_name,
...
version=2
work_dir = f'/opt/ml/level2_objectdetection_cv-level2-cv-13/outputs/{model_name}_{neck_name}_{opt_name}_{lr}_{epoch}_{version}_cosinerestart_12-12'

seed=2022
gpu_ids=[0]

checkpoint_config = dict(max_keep_ckpts=0, interval=0)
device='cuda'