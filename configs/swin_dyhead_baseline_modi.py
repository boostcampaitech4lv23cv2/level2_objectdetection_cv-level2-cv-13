...
while os.path.isdir(f'/opt/ml/level2_objectdetection_cv-level2-cv-13/outputs/{model_name}_{neck_name}_{opt_name}_{lr}_{epoch}_{version}'):
    version += 1
    ...
    hooks = [
        ...
        dict(type='WandbLoggerHook', interval=1000,
            init_kwargs= dict(
                ...
                name = f'{model_type}_{model_name}_{neck_name}_version {version}',
                config= {
